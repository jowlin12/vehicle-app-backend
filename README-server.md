...
- `SUPABASE_SERVICE_KEY`: La clave `service_role`, configurada solamente en Vercel.
- `GOOGLE_DRIVE_CLIENT_ID`: Client ID OAuth de la cuenta de Drive.
- `GOOGLE_DRIVE_CLIENT_SECRET`: Client Secret OAuth de la cuenta de Drive.
...
confirmes archivos `.env` en Git y rota cualquier credencial que haya formado
parte de un APK o del historial del repositorio.
